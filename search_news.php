...
and yourselves.">
<meta name="keyword" value="News_details, edugst">
</head>
...
<div class="bg-warning position-absolute bottom-0 start-50 end-0 z-index:;" style="width: 40%;height: 58px;margin-left: -20px;z-index:1;" id="yellow">  
    ...
    ="font-size:18px;"></i><span class="fw-semibold text-uppercase" style="color:#194369; font-size:18px;  margin-left: -12px;">News Search</span></span>
...
<section>
    ...
    $search = $_REQUEST['search'];
		...
		$sql="SELECT * FROM tbl_news WHERE name='$search' OR description='$search'";
          ...
          <div class="row g-0">
            <div class="col-md-4">
               <a href="news_details?id=<?php echo $row['id'];?>">
                <img src="<?php echo $image;?>" class="img-fluid rounded-start" alt="<?php echo $row['News_name'];?>">
              </a>
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h4 class="card-title heading1"><?php echo $row['name'];?>:</h4>
                <p class="heading"><?php echo $row['creation_on'];?></p>
                <hr>
    ...
    <div class="recent-posts border p-3">
      ...
      <div class="post-item border-bottom">
        ...
        <p > <?php echo $row['name'];?></p>
                        ...
                        <div class="News1-card-footer text-start  mb-2">
