...
$email = $_POST['email'];
 ...
 $user_mail = new Sendmail();
    $owner_mail = new Sendmail();
            ...
            $userMail =  $user_mail->sendingMail($_POST['email'], $_POST['email'], "Thank you for contacting us", "We will contact you soon"); // to user
            $ownerMail = $owner_mail->sendingMail(host_mail, "EduGst", "User Details For Registeration", $messageTemplate); // to owner get info related user
