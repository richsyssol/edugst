 ...
 <div class="row">
            <div class="col-12">
                <div class="card">
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 199.4px;" aria-sort="ascending" aria-label="Banner: activate">Banner</th>
                                                     ...
                                                     <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 199.4px;" aria-sort="ascending" aria-label="srno: activate to sort column descending">Course Name</th>
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM tbl_course Order by creation_on DESC");
                      $cnt=1;
                      $stmt->execute();
                      foreach($stmt as $row){
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a href="course_material.php?id=<?php echo $row['id'];?>" class="dropdown-item"><i class="mdi mdi-plus-circle me-2 text-muted font-18 vertical-middle"></i></i>Course Material</a>
                                         <a href="course_teacher.php?id=<?php echo $row['id'];?>" class="dropdown-item"><i class="mdi mdi-plus-circle me-2 text-muted font-18 vertical-middle"></i></i>Course Teacher</a>
    ...
    success: function(response){
      ...
      $('#edit_price').val(response.price);
       $('#edit_mrp').val(response.mrp);
        $('#edit_teacher').val(response.teacher);
