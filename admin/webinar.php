                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Webinar List</h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
 ...
 <div class="row">
            <div class="col-12">
                <div class="card">
                                 ...
                                 <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 1244px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 199.4px;" aria-sort="ascending" aria-label="srno: activate to sort column descending">Duration</th>
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM tbl_webinar");
                      $cnt=1;
                      $stmt->execute();
                      foreach($stmt as $row){
                      //  $image = (!empty($row['photo'])) ? 'assets/images/side_banner/'.$row['photo'] : 'assets/images/users/profile.jpg';
                        ...
                        <tr class="odd">
                            ...
                            <td><a href="assets/images/webinar/<?php echo $row['image'];?>" target="_blank"><img src="assets/images/webinar/<?php echo $row['image'];?>" width="30"></a></td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#edit" data-id="<?php echo $row['id'];?>" class="dropdown-item edit"><i class="mdi mdi-plus-circle me-2 text-muted font-18 vertical-middle"></i></i>Edit</a>
                                        <a href="webinar_details.php?id=<?php echo $row['id'];?>" class="dropdown-item"><i class="mdi mdi-plus-circle me-2 text-muted font-18 vertical-middle"></i></i>Details</a>
