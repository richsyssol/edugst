...
<?php
	if(isset($_POST['add'])){
		...
		//	$password = password_hash($password, PASSWORD_DEFAULT);
			...
			try{
			 $stmt = $conn->prepare("INSERT INTO tbl_course_type (c_id, name) VALUES (:c_id, :name)");
				$stmt->execute(['c_id'=>$c_id, 'name'=>$name]);
				$_SESSION['success'] = 'Course Material added successfully';
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">Course Material List</h5>
                    ...
                    <div class="col-lg-6" >
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">Course Material Form</h5>
