                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 1244px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 146.4px;" aria-label="Tagline: activate to sort column ascending">Tagline</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 146.4px;" aria-label="Tagline: activate to sort column ascending">Description</th>
                      ...
                      foreach($stmt as $row){
                        ...
                        ?>
                                            <tr class="odd">
                                              ...
                                              <td> <?php echo mb_strimwidth($row['tagline'], 0, 20, "..."); ?></td>
