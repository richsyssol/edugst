<?php
	...
	if(isset($_POST['add'])){
		...
		//	$password = password_hash($password, PASSWORD_DEFAULT);
			...
			try{
				$stmt = $conn->prepare("INSERT INTO  tbl_news  (image, name,description) VALUES (:image, :name, :description)");
				$stmt->execute(['image'=>$new_filename,'name'=>$name, 'description'=>$description]);
