...
<?php include 'left-menu.php'?>
    <div class="content-page">
        ...
        <!-- end of col --->
                    <div class="card">
                        <div class="card-body">
                               <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">News Image</h5>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <textarea class="form-control ckeditor" name="description" rows="10" placeholder="Please enter Description" id="txtEditor" required></textarea>
                                <div class="invalid-feedback">
