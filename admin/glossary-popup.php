   <div class="offcanvas offcanvas-end" tabindex="-1" id="activate" aria-labelledby="offcanvasRightLabel">
                     ...
                     <div class="offcanvas-body">
                         <form class="needs-validation" method="POST" action="keyword-status.php" enctype="multipart/form-data" novalidate>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="add-banner" aria-labelledby="offcanvasExampleLabel">
                     ...
                     <div class="offcanvas-body">
                    <form class="needs-validation" method="POST" action="keyword_add.php" enctype="multipart/form-data" novalidate>
                   
                    
                    <div class="mb-3">
                        <label for="name" class="form-label">Add Keyword </label>
          ...
          <!-- Danger Alert Modal Delete add-user -->
                <div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                        ...
                        <form  method="POST" action="keyword-delete.php">
