<?php
	...
	if(isset($_POST['add'])){
		...
		//	$password = password_hash($password, PASSWORD_DEFAULT);
			...
			try{
				$stmt = $conn->prepare("INSERT INTO our_team (image, name, designation, description) VALUES (:image, :name, :designation, :description)");
				$stmt->execute(['image'=>$new_filename,'name'=>$name, 'designation'=>$designation, 'description'=>$description]);
