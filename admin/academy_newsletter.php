                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Academy Newsletter</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Academy Newsletter</h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
 ...
 <div class="row">
            <div class="col-12">
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="dt-buttons btn-group flex-wrap">
                                         <a href="#add-banner" class="btn btn-danger buttons-html5" data-bs-toggle="offcanvas"><i class="mdi mdi-plus-circle me-2"></i>Add Newsletter</a>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                 ...
                                 <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 1244px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 199.4px;" aria-sort="ascending" aria-label="Banner: activate">File</th>
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM tbl_newsletter");
                      $cnt=1;
                      $stmt->execute();
                      foreach($stmt as $row){
                      //  $image = (!empty($row['photo'])) ? 'assets/images/side_banner/'.$row['photo'] : 'assets/images/users/profile.jpg';
                        ...
                        <tr class="odd">
                            <td><?php echo htmlentities($cnt++);?></td>
                             ...
                             <td><a href="assets/images/newsletter/<?php echo $row['file'];?>" target="_blank"><i class="fa fa-file"></i> Uploaded File</a></td>
