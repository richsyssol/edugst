   <div class="offcanvas offcanvas-end" tabindex="-1" id="activate" aria-labelledby="offcanvasRightLabel">
                     ...
                     <div class="offcanvas-body">
                         <form class="needs-validation" method="POST" action="newsletter-status.php" enctype="multipart/form-data" novalidate>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="add-banner" aria-labelledby="offcanvasExampleLabel">
                                         <div class="offcanvas-header">
                                                    <h5 id="offcanvasRightLabel">Add Newsletter</h5>
                                                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                                </div>
                     <div class="offcanvas-body">
                    <form class="needs-validation" method="POST" action="newsletter_add.php" enctype="multipart/form-data" novalidate>
                    <div class="mb-3">
                        <label for="name" class="form-label">Add Newsletter Name </label>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="banner" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel">Edit File</h5>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <form class="needs-validation" method="POST" action="edit_file.php" enctype="multipart/form-data" novalidate>
                <input type="hidden" name="id" class="catid">
                <div class="mb-3">
        ...
        <div class="offcanvas-body">
            <form class="needs-validation" method="POST" action="edit_newsletter.php" enctype="multipart/form-data" novalidate>
