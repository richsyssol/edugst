...
//	include 'includes/slugify.php';
	...
	$content=$_POST['content'];
		...
		try{
			$stmt = $conn->prepare("UPDATE tbl_webinar SET content=:content WHERE id=:id");
			$stmt->execute(['id'=>$id, 'content'=>$content]);
			$_SESSION['success'] = 'Webinar Detail Updated Successfully !!';
		}
    ...
    <div class="content-page">
            ...
            <div class="contenter-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Webinar Details</h4>
                        </div>
                    </div>
                </div>  
                <?php
                ...
                ?>  
                 <?php
                    ...
                    $id=intval($_GET['id']);
                    $query=mysqli_query($conn,"SELECT * FROM tbl_webinar WHERE id='$id'");
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <textarea class="form-control ckeditor" name="content" rows="10" placeholder="Please enter Description" id="txtEditor" ><?php echo $row['content'];?></textarea>
                </div>
            </div>
