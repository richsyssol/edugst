 ...
 <div class="row">
            <div class="col-12">
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="dt-buttons btn-group flex-wrap">
                                         <a href="#add-banner" class="btn btn-danger buttons-html5" data-bs-toggle="offcanvas"><i class="mdi mdi-plus-circle me-2"></i>Add Keyword</a>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                 ...
                                 <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 1244px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 199.4px;" aria-sort="ascending" aria-label="srno: activate to sort column descending">Keyword</th>
                                                     ...
                                                     <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 125.4px;" aria-label="Action: activate to sort column ascending">Creation on</th>
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM tbl_keyword");
                      $cnt=1;
                      $stmt->execute();
                      foreach($stmt as $row){
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="glossary_add.php?id=<?php echo $row['id'];?>" class="dropdown-item"><i class="mdi mdi-plus-circle me-2 text-muted font-18 vertical-middle"></i></i>Glossary Add</a>
           ...
           <?php 
            ...
            <?php include 'glossary-popup.php'?>
