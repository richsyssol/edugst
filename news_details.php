...
<head>
    ...
    <title>Edu-gst | News Details</title>
...
<div class=" position-absolute bottom-0 " style="width: 50%;height: 80px;z-index:2;" id="purple">
    <div class=" textClass1 ">
        <h2 class="text-uppercase fw-semibold " >News  </h2>
    </div>
</div>
...
<div class="bg-warning position-absolute bottom-0 start-50 end-0 z-index:;" style="width: 40%;height: 58px;margin-left: -20px;z-index:1;" id="yellow">  
    ...
    <span class="d-flex align-items-center ">   <a href="index"><i class="fa-solid fa-house m-0 p-0 text-white" style="font-size:16px; "></i></a><i class="m-0 p-0 fa-solid fa-angle-right" style
    ="font-size:18px;"></i><span class="fw-semibold text-uppercase" style="color:#194369; font-size:18px;  margin-left: -12px;">News Details</span></span>
    ...
    <div class="row">
      ...
      <div class="col-12 about11-section d-flex align-items-center justify-content-center py-2">
        <div class="textclass1t">
          <h2 class="text-uppercase fw-semibold text-center text-white">News</h2>
        </div>
      </div>
      ...
      <div class="col-12 d-flex breadcrumb-section align-items-center justify-content-center">
        <div class="newsletter-input-wrapper">
          <span class="d-flex align-items-center">
            ...
            <i class=" fa-solid fa-angle-right " style="font-size: 14px;"></i>
            <span class="fw-semibold" style="color: #194369;">NEWS DETAIL'S</span>
          </span>
        </div>
      </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="post-header mb-4">
                    <img src="<?php echo $image;?>" style="height:428px; width:1170px;" alt="<?php echo $row['name'];?>" class="img-fluid  rounded">
                </div>

                <!-- Post Title and Meta -->
                <div class="post-title">
                    <h5 class="mt-5 fw-semibold "><?php echo $row['name'];?></h5>
                              <div class="blog1-card-footer text-start  mb-4">
                    <span class="text-black" style="font-size: 14px; "><i class="fa-solid fa-clock text-warning " style="font-size: 14px; width:23px!important;"></i> <?php echo $row['creation_on'];?></span>
...
<!--</div>-->
  ...
  <div class="mb-4">
    ...
    <div class="search-box p-3 border">
      <form action="search_news" method="GET" class="d-flex">
  ...
  <div class="">
    <div class="section-title">
        <h6 class="fw-semibold">RECENT News</h6>
    </div>
    <div class="recent-posts border p-3">
        ...
        try{
          $stmt = $conn->prepare("SELECT * FROM tbl_news Order By rand() DESC LIMIT 5");
          $cnt=1;
          $stmt->execute();
          foreach($stmt as $row){
            $image = (!empty($row['image'])) ? 'admin/assets/images/news/'.$row['image'] : 'assets/images/users/profile.jpg';
    ...
    ?>
      <div class="post-item border-bottom">
        <a href="news_details?id=<?php echo $row['id'];?>" class="text-decoration-none text-dark">
        <p > <?php echo $row['name'];?></p>
        </a>
                        <div class="blog1-card-footer text-start  mb-2">
                    <span class="text-black" style="font-size: 14px;"><i class="fa-solid fa-calendar-days text-warning " style="font-size: 14px; width:23px!important;"></i>  <?php echo $row['creation_on'];?></span>
                    <!--<span  class="text-black" style="font-size: 14px;"><i class="fa-solid fa-comments text-warning " style="font-size: 14px; width:23px!important;"></i> 0</span>-->
                   <!-- <span  class="text-black" style="font-size: 14px;"><i class="fa-solid fa-eye text-warning" style="font-size: 14px; width:23px!important;"></i> 3732</span>-->
                </div>
      </div>
